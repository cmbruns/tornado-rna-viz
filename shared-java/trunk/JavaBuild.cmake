...
CONFIGURE_FILE(${PRODUCT_VERSION_JAVA_TEMPLATE} ${CMAKE_BINARY_DIR}/${VERSION_SOURCE_FILE_NAME})
ADD_CUSTOM_TARGET(${JAR_FILE_NAME}-version ALL ${CMAKE_Java_COMPILER} -d ${CLASS_OUTPUT_PATH} ${CMAKE_BINARY_DIR}/${VERSION_SOURCE_FILE_NAME})
