...
CONFIGURE_FILE(${PRODUCT_VERSION_JAVA_TEMPLATE} ${CLASS_OUTPUT_PATH}/${VERSION_SOURCE_FILE_NAME})
ADD_CUSTOM_TARGET(${JAR_FILE_NAME}-version ALL ${CMAKE_Java_COMPILER} -d ${CLASS_OUTPUT_PATH} ${CLASS_OUTPUT_PATH}/${VERSION_SOURCE_FILE_NAME})
