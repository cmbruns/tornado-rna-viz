...
public class meanType extends com.altova.xml.Node {

	public meanType(meanType node) {
		super(node);
	}

	public meanType(org.w3c.dom.Node node) {
		super(node);
	}

	public meanType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public meanType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
