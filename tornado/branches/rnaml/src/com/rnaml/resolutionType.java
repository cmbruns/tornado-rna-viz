...
public class resolutionType extends com.altova.xml.Node {

	public resolutionType(resolutionType node) {
		super(node);
	}

	public resolutionType(org.w3c.dom.Node node) {
		super(node);
	}

	public resolutionType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public resolutionType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
