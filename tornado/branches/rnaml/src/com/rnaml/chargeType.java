...
public class chargeType extends com.altova.xml.Node {

	public chargeType(chargeType node) {
		super(node);
	}

	public chargeType(org.w3c.dom.Node node) {
		super(node);
	}

	public chargeType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public chargeType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
