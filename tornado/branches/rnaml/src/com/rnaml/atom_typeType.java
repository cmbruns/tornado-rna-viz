...
public class atom_typeType extends com.altova.xml.Node {

	public atom_typeType(atom_typeType node) {
		super(node);
	}

	public atom_typeType(org.w3c.dom.Node node) {
		super(node);
	}

	public atom_typeType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public atom_typeType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
