...
public class temp_factorType extends com.altova.xml.Node {

	public temp_factorType(temp_factorType node) {
		super(node);
	}

	public temp_factorType(org.w3c.dom.Node node) {
		super(node);
	}

	public temp_factorType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public temp_factorType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
