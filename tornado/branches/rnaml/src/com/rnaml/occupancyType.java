...
public class occupancyType extends com.altova.xml.Node {

	public occupancyType(occupancyType node) {
		super(node);
	}

	public occupancyType(org.w3c.dom.Node node) {
		super(node);
	}

	public occupancyType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public occupancyType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
