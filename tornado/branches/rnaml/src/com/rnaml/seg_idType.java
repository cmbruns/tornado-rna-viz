...
public class seg_idType extends com.altova.xml.Node {

	public seg_idType(seg_idType node) {
		super(node);
	}

	public seg_idType(org.w3c.dom.Node node) {
		super(node);
	}

	public seg_idType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public seg_idType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
