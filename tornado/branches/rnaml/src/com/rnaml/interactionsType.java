...
public class interactionsType extends com.altova.xml.Node {

	public interactionsType(interactionsType node) {
		super(node);
	}

	public interactionsType(org.w3c.dom.Node node) {
		super(node);
	}

	public interactionsType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public interactionsType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
