...
public class editorType extends com.altova.xml.Node {

	public editorType(editorType node) {
		super(node);
	}

	public editorType(org.w3c.dom.Node node) {
		super(node);
	}

	public editorType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public editorType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
