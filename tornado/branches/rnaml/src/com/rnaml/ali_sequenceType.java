...
public class ali_sequenceType extends com.altova.xml.Node {

	public ali_sequenceType(ali_sequenceType node) {
		super(node);
	}

	public ali_sequenceType(org.w3c.dom.Node node) {
		super(node);
	}

	public ali_sequenceType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public ali_sequenceType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
