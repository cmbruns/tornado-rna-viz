...
public class entryType extends com.altova.xml.Node {

	public entryType(entryType node) {
		super(node);
	}

	public entryType(org.w3c.dom.Node node) {
		super(node);
	}

	public entryType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public entryType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
