...
public class startType extends com.altova.xml.Node {

	public startType(startType node) {
		super(node);
	}

	public startType(org.w3c.dom.Node node) {
		super(node);
	}

	public startType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public startType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
