...
public class seg_nameType extends com.altova.xml.Node {

	public seg_nameType(seg_nameType node) {
		super(node);
	}

	public seg_nameType(org.w3c.dom.Node node) {
		super(node);
	}

	public seg_nameType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public seg_nameType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
