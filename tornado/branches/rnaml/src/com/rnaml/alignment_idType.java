...
public class alignment_idType extends com.altova.xml.Node {

	public alignment_idType(alignment_idType node) {
		super(node);
	}

	public alignment_idType(org.w3c.dom.Node node) {
		super(node);
	}

	public alignment_idType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public alignment_idType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
