...
public class free_energyType extends com.altova.xml.Node {

	public free_energyType(free_energyType node) {
		super(node);
	}

	public free_energyType(org.w3c.dom.Node node) {
		super(node);
	}

	public free_energyType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public free_energyType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
