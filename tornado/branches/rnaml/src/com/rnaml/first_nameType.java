...
public class first_nameType extends com.altova.xml.Node {

	public first_nameType(first_nameType node) {
		super(node);
	}

	public first_nameType(org.w3c.dom.Node node) {
		super(node);
	}

	public first_nameType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public first_nameType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
