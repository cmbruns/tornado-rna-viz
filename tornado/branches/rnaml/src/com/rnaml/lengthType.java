...
public class lengthType extends com.altova.xml.Node {

	public lengthType(lengthType node) {
		super(node);
	}

	public lengthType(org.w3c.dom.Node node) {
		super(node);
	}

	public lengthType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public lengthType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
