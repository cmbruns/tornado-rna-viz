...
public class dayType extends com.altova.xml.Node {

	public dayType(dayType node) {
		super(node);
	}

	public dayType(org.w3c.dom.Node node) {
		super(node);
	}

	public dayType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public dayType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
