...
public class yearType extends com.altova.xml.Node {

	public yearType(yearType node) {
		super(node);
	}

	public yearType(org.w3c.dom.Node node) {
		super(node);
	}

	public yearType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public yearType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
