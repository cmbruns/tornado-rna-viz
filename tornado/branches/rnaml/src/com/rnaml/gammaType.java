...
public class gammaType extends com.altova.xml.Node {

	public gammaType(gammaType node) {
		super(node);
	}

	public gammaType(org.w3c.dom.Node node) {
		super(node);
	}

	public gammaType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public gammaType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
