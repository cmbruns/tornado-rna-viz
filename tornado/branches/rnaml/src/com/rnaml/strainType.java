...
public class strainType extends com.altova.xml.Node {

	public strainType(strainType node) {
		super(node);
	}

	public strainType(org.w3c.dom.Node node) {
		super(node);
	}

	public strainType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public strainType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
