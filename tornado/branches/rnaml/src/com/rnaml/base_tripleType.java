...
public class base_tripleType extends com.altova.xml.Node {

	public base_tripleType(base_tripleType node) {
		super(node);
	}

	public base_tripleType(org.w3c.dom.Node node) {
		super(node);
	}

	public base_tripleType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public base_tripleType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "base-pair-id" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "base-pair-id", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new base_pair_idType(tmpNode).adjustPrefix();
		}
	}
	...
	public base_pairType getbase_pair() throws Exception 
 {
	...
	public static int getbase_pair_idMinCount() {
		return 3;
	}

	public static int getbase_pair_idMaxCount() {
		return 3;
	}

	public int getbase_pair_idCount() {
		return getDomChildCount(Element, null, "base-pair-id");
	}

	public boolean hasbase_pair_id() {
		return hasDomChild(Element, null, "base-pair-id");
	}

	public base_pair_idType newbase_pair_id() {
		return new base_pair_idType(domNode.getOwnerDocument().createElementNS(null, "base-pair-id"));
	}

	public base_pair_idType getbase_pair_idAt(int index) throws Exception {
		return new base_pair_idType(dereference(getDomChildAt(Element, null, "base-pair-id", index)));
	}

	public org.w3c.dom.Node getStartingbase_pair_idCursor() throws Exception {
		return getDomFirstChild(Element, null, "base-pair-id" );
	}

	public org.w3c.dom.Node getAdvancedbase_pair_idCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "base-pair-id", curNode );
	}

	public base_pair_idType getbase_pair_idValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new base_pair_idType( dereference(curNode) );
	}

	public base_pair_idType getbase_pair_id() throws Exception 
 {
		return getbase_pair_idAt(0);
	}

	public void removebase_pair_idAt(int index) {
		removeDomChildAt(Element, null, "base-pair-id", index);
	}

	public void removebase_pair_id() {
		removebase_pair_idAt(0);
	}

	public void addbase_pair_id(base_pair_idType value) {
		appendDomElement(null, "base-pair-id", value);	
	}

	public void insertbase_pair_idAt(base_pair_idType value, int index) {
		insertDomElementAt(null, "base-pair-id", index, value);
	}

	public void replacebase_pair_idAt(base_pair_idType value, int index) {
		replaceDomElementAt(null, "base-pair-id", index, value);
	}
