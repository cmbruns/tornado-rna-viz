...
public class titleType extends com.altova.xml.Node {

	public titleType(titleType node) {
		super(node);
	}

	public titleType(org.w3c.dom.Node node) {
		super(node);
	}

	public titleType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public titleType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
