...
public class nu3Type extends com.altova.xml.Node {

	public nu3Type(nu3Type node) {
		super(node);
	}

	public nu3Type(org.w3c.dom.Node node) {
		super(node);
	}

	public nu3Type(org.w3c.dom.Document doc) {
		super(doc);
	}

	public nu3Type(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
