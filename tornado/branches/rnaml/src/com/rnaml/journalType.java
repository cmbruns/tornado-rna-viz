...
public class journalType extends com.altova.xml.Node {

	public journalType(journalType node) {
		super(node);
	}

	public journalType(org.w3c.dom.Node node) {
		super(node);
	}

	public journalType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public journalType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
