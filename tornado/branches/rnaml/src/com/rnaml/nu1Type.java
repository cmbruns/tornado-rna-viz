...
public class nu1Type extends com.altova.xml.Node {

	public nu1Type(nu1Type node) {
		super(node);
	}

	public nu1Type(org.w3c.dom.Node node) {
		super(node);
	}

	public nu1Type(org.w3c.dom.Document doc) {
		super(doc);
	}

	public nu1Type(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
