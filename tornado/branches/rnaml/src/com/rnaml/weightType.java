...
public class weightType extends com.altova.xml.Node {

	public weightType(weightType node) {
		super(node);
	}

	public weightType(org.w3c.dom.Node node) {
		super(node);
	}

	public weightType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public weightType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
