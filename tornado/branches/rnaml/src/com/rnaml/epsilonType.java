...
public class epsilonType extends com.altova.xml.Node {

	public epsilonType(epsilonType node) {
		super(node);
	}

	public epsilonType(org.w3c.dom.Node node) {
		super(node);
	}

	public epsilonType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public epsilonType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
