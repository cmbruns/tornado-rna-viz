...
public class edge_3pType extends com.altova.xml.Node {

	public edge_3pType(edge_3pType node) {
		super(node);
	}

	public edge_3pType(org.w3c.dom.Node node) {
		super(node);
	}

	public edge_3pType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public edge_3pType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
