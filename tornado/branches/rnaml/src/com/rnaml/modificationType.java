...
public class modificationType extends com.altova.xml.Node {

	public modificationType(modificationType node) {
		super(node);
	}

	public modificationType(org.w3c.dom.Node node) {
		super(node);
	}

	public modificationType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public modificationType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "modified-type" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "modified-type", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new modified_typeType(tmpNode).adjustPrefix();
		}
	}
	...
	public base_idType getbase_id() throws Exception 
 {
	...
	public static int getmodified_typeMinCount() {
		return 1;
	}

	public static int getmodified_typeMaxCount() {
		return 1;
	}

	public int getmodified_typeCount() {
		return getDomChildCount(Element, null, "modified-type");
	}

	public boolean hasmodified_type() {
		return hasDomChild(Element, null, "modified-type");
	}

	public modified_typeType newmodified_type() {
		return new modified_typeType(domNode.getOwnerDocument().createElementNS(null, "modified-type"));
	}

	public modified_typeType getmodified_typeAt(int index) throws Exception {
		return new modified_typeType(dereference(getDomChildAt(Element, null, "modified-type", index)));
	}

	public org.w3c.dom.Node getStartingmodified_typeCursor() throws Exception {
		return getDomFirstChild(Element, null, "modified-type" );
	}

	public org.w3c.dom.Node getAdvancedmodified_typeCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "modified-type", curNode );
	}

	public modified_typeType getmodified_typeValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new modified_typeType( dereference(curNode) );
	}

	public modified_typeType getmodified_type() throws Exception 
 {
		return getmodified_typeAt(0);
	}

	public void removemodified_typeAt(int index) {
		removeDomChildAt(Element, null, "modified-type", index);
	}

	public void removemodified_type() {
		while (hasmodified_type())
			removemodified_typeAt(0);
	}

	public void addmodified_type(modified_typeType value) {
		appendDomElement(null, "modified-type", value);	
	}

	public void insertmodified_typeAt(modified_typeType value, int index) {
		insertDomElementAt(null, "modified-type", index, value);
	}

	public void replacemodified_typeAt(modified_typeType value, int index) {
		replaceDomElementAt(null, "modified-type", index, value);
	}
