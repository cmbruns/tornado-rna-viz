...
public class pubmed_idType extends com.altova.xml.Node {

	public pubmed_idType(pubmed_idType node) {
		super(node);
	}

	public pubmed_idType(org.w3c.dom.Node node) {
		super(node);
	}

	public pubmed_idType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public pubmed_idType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
