...
public class kingdomType extends com.altova.xml.Node {

	public kingdomType(kingdomType node) {
		super(node);
	}

	public kingdomType(org.w3c.dom.Node node) {
		super(node);
	}

	public kingdomType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public kingdomType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
