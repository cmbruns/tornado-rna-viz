...
public class phylumType extends com.altova.xml.Node {

	public phylumType(phylumType node) {
		super(node);
	}

	public phylumType(org.w3c.dom.Node node) {
		super(node);
	}

	public phylumType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public phylumType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
