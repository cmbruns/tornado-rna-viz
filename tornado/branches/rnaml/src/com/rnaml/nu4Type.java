...
public class nu4Type extends com.altova.xml.Node {

	public nu4Type(nu4Type node) {
		super(node);
	}

	public nu4Type(org.w3c.dom.Node node) {
		super(node);
	}

	public nu4Type(org.w3c.dom.Document doc) {
		super(doc);
	}

	public nu4Type(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
