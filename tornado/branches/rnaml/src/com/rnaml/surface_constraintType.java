...
public class surface_constraintType extends com.altova.xml.Node {

	public surface_constraintType(surface_constraintType node) {
		super(node);
	}

	public surface_constraintType(org.w3c.dom.Node node) {
		super(node);
	}

	public surface_constraintType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public surface_constraintType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "surface-value" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "surface-value", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new surface_valueType(tmpNode).adjustPrefix();
		}
	}
	...
	public atom_typeType getatom_type() throws Exception 
 {
	...
	public static int getsurface_valueMinCount() {
		return 0;
	}

	public static int getsurface_valueMaxCount() {
		return 1;
	}

	public int getsurface_valueCount() {
		return getDomChildCount(Element, null, "surface-value");
	}

	public boolean hassurface_value() {
		return hasDomChild(Element, null, "surface-value");
	}

	public surface_valueType newsurface_value() {
		return new surface_valueType(domNode.getOwnerDocument().createElementNS(null, "surface-value"));
	}

	public surface_valueType getsurface_valueAt(int index) throws Exception {
		return new surface_valueType(dereference(getDomChildAt(Element, null, "surface-value", index)));
	}

	public org.w3c.dom.Node getStartingsurface_valueCursor() throws Exception {
		return getDomFirstChild(Element, null, "surface-value" );
	}

	public org.w3c.dom.Node getAdvancedsurface_valueCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "surface-value", curNode );
	}

	public surface_valueType getsurface_valueValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new surface_valueType( dereference(curNode) );
	}

	public surface_valueType getsurface_value() throws Exception 
 {
		return getsurface_valueAt(0);
	}

	public void removesurface_valueAt(int index) {
		removeDomChildAt(Element, null, "surface-value", index);
	}

	public void removesurface_value() {
		while (hassurface_value())
			removesurface_valueAt(0);
	}

	public void addsurface_value(surface_valueType value) {
		appendDomElement(null, "surface-value", value);	
	}

	public void insertsurface_valueAt(surface_valueType value, int index) {
		insertDomElementAt(null, "surface-value", index, value);
	}

	public void replacesurface_valueAt(surface_valueType value, int index) {
		replaceDomElementAt(null, "surface-value", index, value);
	}
