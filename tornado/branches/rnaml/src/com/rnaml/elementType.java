...
public class elementType extends com.altova.xml.Node {

	public elementType(elementType node) {
		super(node);
	}

	public elementType(org.w3c.dom.Node node) {
		super(node);
	}

	public elementType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public elementType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
