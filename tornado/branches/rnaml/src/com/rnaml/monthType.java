...
public class monthType extends com.altova.xml.Node {

	public monthType(monthType node) {
		super(node);
	}

	public monthType(org.w3c.dom.Node node) {
		super(node);
	}

	public monthType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public monthType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
