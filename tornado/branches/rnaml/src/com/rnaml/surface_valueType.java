...
public class surface_valueType extends com.altova.xml.Node {

	public surface_valueType(surface_valueType node) {
		super(node);
	}

	public surface_valueType(org.w3c.dom.Node node) {
		super(node);
	}

	public surface_valueType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public surface_valueType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
