...
public class prog_versionType extends com.altova.xml.Node {

	public prog_versionType(prog_versionType node) {
		super(node);
	}

	public prog_versionType(org.w3c.dom.Node node) {
		super(node);
	}

	public prog_versionType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public prog_versionType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
