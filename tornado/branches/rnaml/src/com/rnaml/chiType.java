...
public class chiType extends com.altova.xml.Node {

	public chiType(chiType node) {
		super(node);
	}

	public chiType(org.w3c.dom.Node node) {
		super(node);
	}

	public chiType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public chiType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
