...
public class betaType extends com.altova.xml.Node {

	public betaType(betaType node) {
		super(node);
	}

	public betaType(org.w3c.dom.Node node) {
		super(node);
	}

	public betaType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public betaType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
