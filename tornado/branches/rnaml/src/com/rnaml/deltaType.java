...
public class deltaType extends com.altova.xml.Node {

	public deltaType(deltaType node) {
		super(node);
	}

	public deltaType(org.w3c.dom.Node node) {
		super(node);
	}

	public deltaType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public deltaType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
