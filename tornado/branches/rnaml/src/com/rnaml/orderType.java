...
public class orderType extends com.altova.xml.Node {

	public orderType(orderType node) {
		super(node);
	}

	public orderType(org.w3c.dom.Node node) {
		super(node);
	}

	public orderType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public orderType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
