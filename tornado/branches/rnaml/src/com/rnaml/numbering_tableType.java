...
public class numbering_tableType extends com.altova.xml.Node {

	public numbering_tableType(numbering_tableType node) {
		super(node);
	}

	public numbering_tableType(org.w3c.dom.Node node) {
		super(node);
	}

	public numbering_tableType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public numbering_tableType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
