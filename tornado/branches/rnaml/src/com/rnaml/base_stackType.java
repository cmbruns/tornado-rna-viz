...
public class base_stackType extends com.altova.xml.Node {

	public base_stackType(base_stackType node) {
		super(node);
	}

	public base_stackType(org.w3c.dom.Node node) {
		super(node);
	}

	public base_stackType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public base_stackType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
