...
public class coordinatesType extends com.altova.xml.Node {

	public coordinatesType(coordinatesType node) {
		super(node);
	}

	public coordinatesType(org.w3c.dom.Node node) {
		super(node);
	}

	public coordinatesType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public coordinatesType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
