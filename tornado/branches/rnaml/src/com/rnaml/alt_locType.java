...
public class alt_locType extends com.altova.xml.Node {

	public alt_locType(alt_locType node) {
		super(node);
	}

	public alt_locType(org.w3c.dom.Node node) {
		super(node);
	}

	public alt_locType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public alt_locType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
