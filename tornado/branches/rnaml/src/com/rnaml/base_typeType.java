...
public class base_typeType extends com.altova.xml.Node {

	public base_typeType(base_typeType node) {
		super(node);
	}

	public base_typeType(org.w3c.dom.Node node) {
		super(node);
	}

	public base_typeType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public base_typeType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
