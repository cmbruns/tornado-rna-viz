...
public class alignmentType extends com.altova.xml.Node {

	public alignmentType(alignmentType node) {
		super(node);
	}

	public alignmentType(org.w3c.dom.Node node) {
		super(node);
	}

	public alignmentType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public alignmentType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "ali-sequence" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "ali-sequence", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new ali_sequenceType(tmpNode).adjustPrefix();
		}
	}
	...
	public SchemaIDRef getdatabase_ids() throws Exception 
 {
	...
	public static int getali_sequenceMinCount() {
		return 0;
	}

	public static int getali_sequenceMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getali_sequenceCount() {
		return getDomChildCount(Element, null, "ali-sequence");
	}

	public boolean hasali_sequence() {
		return hasDomChild(Element, null, "ali-sequence");
	}

	public ali_sequenceType newali_sequence() {
		return new ali_sequenceType(domNode.getOwnerDocument().createElementNS(null, "ali-sequence"));
	}

	public ali_sequenceType getali_sequenceAt(int index) throws Exception {
		return new ali_sequenceType(dereference(getDomChildAt(Element, null, "ali-sequence", index)));
	}

	public org.w3c.dom.Node getStartingali_sequenceCursor() throws Exception {
		return getDomFirstChild(Element, null, "ali-sequence" );
	}

	public org.w3c.dom.Node getAdvancedali_sequenceCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "ali-sequence", curNode );
	}

	public ali_sequenceType getali_sequenceValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new ali_sequenceType( dereference(curNode) );
	}

	public ali_sequenceType getali_sequence() throws Exception 
 {
		return getali_sequenceAt(0);
	}

	public void removeali_sequenceAt(int index) {
		removeDomChildAt(Element, null, "ali-sequence", index);
	}

	public void removeali_sequence() {
		while (hasali_sequence())
			removeali_sequenceAt(0);
	}

	public void addali_sequence(ali_sequenceType value) {
		appendDomElement(null, "ali-sequence", value);	
	}

	public void insertali_sequenceAt(ali_sequenceType value, int index) {
		insertDomElementAt(null, "ali-sequence", index, value);
	}

	public void replaceali_sequenceAt(ali_sequenceType value, int index) {
		replaceDomElementAt(null, "ali-sequence", index, value);
	}
