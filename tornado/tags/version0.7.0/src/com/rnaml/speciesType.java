...
public class speciesType extends com.altova.xml.Node {

	public speciesType(speciesType node) {
		super(node);
	}

	public speciesType(org.w3c.dom.Node node) {
		super(node);
	}

	public speciesType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public speciesType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
