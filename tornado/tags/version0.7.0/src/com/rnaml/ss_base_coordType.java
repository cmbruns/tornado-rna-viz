...
public class ss_base_coordType extends com.altova.xml.Node {

	public ss_base_coordType(ss_base_coordType node) {
		super(node);
	}

	public ss_base_coordType(org.w3c.dom.Node node) {
		super(node);
	}

	public ss_base_coordType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public ss_base_coordType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
