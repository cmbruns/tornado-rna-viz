...
public class prog_nameType extends com.altova.xml.Node {

	public prog_nameType(prog_nameType node) {
		super(node);
	}

	public prog_nameType(org.w3c.dom.Node node) {
		super(node);
	}

	public prog_nameType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public prog_nameType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
