...
public class nu2Type extends com.altova.xml.Node {

	public nu2Type(nu2Type node) {
		super(node);
	}

	public nu2Type(org.w3c.dom.Node node) {
		super(node);
	}

	public nu2Type(org.w3c.dom.Document doc) {
		super(doc);
	}

	public nu2Type(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
