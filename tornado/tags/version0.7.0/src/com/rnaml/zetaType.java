...
public class zetaType extends com.altova.xml.Node {

	public zetaType(zetaType node) {
		super(node);
	}

	public zetaType(org.w3c.dom.Node node) {
		super(node);
	}

	public zetaType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public zetaType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
