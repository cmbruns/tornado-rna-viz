...
public class endType extends com.altova.xml.Node {

	public endType(endType node) {
		super(node);
	}

	public endType(org.w3c.dom.Node node) {
		super(node);
	}

	public endType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public endType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
