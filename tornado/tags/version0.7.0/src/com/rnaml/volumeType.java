...
public class volumeType extends com.altova.xml.Node {

	public volumeType(volumeType node) {
		super(node);
	}

	public volumeType(org.w3c.dom.Node node) {
		super(node);
	}

	public volumeType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public volumeType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
