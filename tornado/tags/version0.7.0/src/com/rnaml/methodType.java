...
public class methodType extends com.altova.xml.Node {

	public methodType(methodType node) {
		super(node);
	}

	public methodType(org.w3c.dom.Node node) {
		super(node);
	}

	public methodType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public methodType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
