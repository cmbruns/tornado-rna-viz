...
public class last_nameType extends com.altova.xml.Node {

	public last_nameType(last_nameType node) {
		super(node);
	}

	public last_nameType(org.w3c.dom.Node node) {
		super(node);
	}

	public last_nameType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public last_nameType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
