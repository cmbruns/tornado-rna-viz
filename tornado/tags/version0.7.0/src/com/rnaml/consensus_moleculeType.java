...
public class consensus_moleculeType extends com.altova.xml.Node {

	public consensus_moleculeType(consensus_moleculeType node) {
		super(node);
	}

	public consensus_moleculeType(org.w3c.dom.Node node) {
		super(node);
	}

	public consensus_moleculeType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public consensus_moleculeType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "alignment-id" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "alignment-id", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new alignment_idType(tmpNode).adjustPrefix();
		}
	...
	public SchemaIDRef getdatabase_ids() throws Exception 
 {
	...
	public static int getalignment_idMinCount() {
		return 1;
	}

	public static int getalignment_idMaxCount() {
		return 1;
	}

	public int getalignment_idCount() {
		return getDomChildCount(Element, null, "alignment-id");
	}

	public boolean hasalignment_id() {
		return hasDomChild(Element, null, "alignment-id");
	}

	public alignment_idType newalignment_id() {
		return new alignment_idType(domNode.getOwnerDocument().createElementNS(null, "alignment-id"));
	}

	public alignment_idType getalignment_idAt(int index) throws Exception {
		return new alignment_idType(dereference(getDomChildAt(Element, null, "alignment-id", index)));
	}

	public org.w3c.dom.Node getStartingalignment_idCursor() throws Exception {
		return getDomFirstChild(Element, null, "alignment-id" );
	}

	public org.w3c.dom.Node getAdvancedalignment_idCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "alignment-id", curNode );
	}

	public alignment_idType getalignment_idValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new alignment_idType( dereference(curNode) );
	}

	public alignment_idType getalignment_id() throws Exception 
 {
		return getalignment_idAt(0);
	}

	public void removealignment_idAt(int index) {
		removeDomChildAt(Element, null, "alignment-id", index);
	}

	public void removealignment_id() {
		while (hasalignment_id())
			removealignment_idAt(0);
	}

	public void addalignment_id(alignment_idType value) {
		appendDomElement(null, "alignment-id", value);	
	}

	public void insertalignment_idAt(alignment_idType value, int index) {
		insertDomElementAt(null, "alignment-id", index, value);
	}

	public void replacealignment_idAt(alignment_idType value, int index) {
		replaceDomElementAt(null, "alignment-id", index, value);
	}
