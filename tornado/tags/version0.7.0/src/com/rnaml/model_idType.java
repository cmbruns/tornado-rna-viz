...
public class model_idType extends com.altova.xml.Node {

	public model_idType(model_idType node) {
		super(node);
	}

	public model_idType(org.w3c.dom.Node node) {
		super(node);
	}

	public model_idType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public model_idType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public SchemaString getrefAt(int index) throws Exception {
		return new SchemaString(getDomNodeValue(dereference(getDomChildAt(Attribute, null, "ref", index))));
	}
