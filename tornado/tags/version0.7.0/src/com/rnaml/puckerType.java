...
public class puckerType extends com.altova.xml.Node {

	public puckerType(puckerType node) {
		super(node);
	}

	public puckerType(org.w3c.dom.Node node) {
		super(node);
	}

	public puckerType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public puckerType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
