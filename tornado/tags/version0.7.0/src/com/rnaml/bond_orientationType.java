...
public class bond_orientationType extends com.altova.xml.Node {

	public bond_orientationType(bond_orientationType node) {
		super(node);
	}

	public bond_orientationType(org.w3c.dom.Node node) {
		super(node);
	}

	public bond_orientationType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public bond_orientationType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
