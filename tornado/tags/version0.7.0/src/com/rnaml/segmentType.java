...
public class segmentType extends com.altova.xml.Node {

	public segmentType(segmentType node) {
		super(node);
	}

	public segmentType(org.w3c.dom.Node node) {
		super(node);
	}

	public segmentType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public segmentType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "seg-name" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "seg-name", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new seg_nameType(tmpNode).adjustPrefix();
		}
	...
	public SchemaIDRef getdatabase_ids() throws Exception 
 {
	...
	public static int getseg_nameMinCount() {
		return 0;
	}

	public static int getseg_nameMaxCount() {
		return 1;
	}

	public int getseg_nameCount() {
		return getDomChildCount(Element, null, "seg-name");
	}

	public boolean hasseg_name() {
		return hasDomChild(Element, null, "seg-name");
	}

	public seg_nameType newseg_name() {
		return new seg_nameType(domNode.getOwnerDocument().createElementNS(null, "seg-name"));
	}

	public seg_nameType getseg_nameAt(int index) throws Exception {
		return new seg_nameType(dereference(getDomChildAt(Element, null, "seg-name", index)));
	}

	public org.w3c.dom.Node getStartingseg_nameCursor() throws Exception {
		return getDomFirstChild(Element, null, "seg-name" );
	}

	public org.w3c.dom.Node getAdvancedseg_nameCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "seg-name", curNode );
	}

	public seg_nameType getseg_nameValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new seg_nameType( dereference(curNode) );
	}

	public seg_nameType getseg_name() throws Exception 
 {
		return getseg_nameAt(0);
	}

	public void removeseg_nameAt(int index) {
		removeDomChildAt(Element, null, "seg-name", index);
	}

	public void removeseg_name() {
		while (hasseg_name())
			removeseg_nameAt(0);
	}

	public void addseg_name(seg_nameType value) {
		appendDomElement(null, "seg-name", value);	
	}

	public void insertseg_nameAt(seg_nameType value, int index) {
		insertDomElementAt(null, "seg-name", index, value);
	}

	public void replaceseg_nameAt(seg_nameType value, int index) {
		replaceDomElementAt(null, "seg-name", index, value);
	}
