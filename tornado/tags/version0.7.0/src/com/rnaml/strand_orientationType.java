...
public class strand_orientationType extends com.altova.xml.Node {

	public strand_orientationType(strand_orientationType node) {
		super(node);
	}

	public strand_orientationType(org.w3c.dom.Node node) {
		super(node);
	}

	public strand_orientationType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public strand_orientationType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
