...
public class single_strandType extends com.altova.xml.Node {

	public single_strandType(single_strandType node) {
		super(node);
	}

	public single_strandType(org.w3c.dom.Node node) {
		super(node);
	}

	public single_strandType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public single_strandType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
