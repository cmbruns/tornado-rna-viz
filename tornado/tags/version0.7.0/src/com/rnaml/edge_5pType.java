...
public class edge_5pType extends com.altova.xml.Node {

	public edge_5pType(edge_5pType node) {
		super(node);
	}

	public edge_5pType(org.w3c.dom.Node node) {
		super(node);
	}

	public edge_5pType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public edge_5pType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
