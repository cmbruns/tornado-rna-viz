...
public class familyType extends com.altova.xml.Node {

	public familyType(familyType node) {
		super(node);
	}

	public familyType(org.w3c.dom.Node node) {
		super(node);
	}

	public familyType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public familyType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
