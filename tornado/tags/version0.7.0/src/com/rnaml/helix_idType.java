...
public class helix_idType extends com.altova.xml.Node {

	public helix_idType(helix_idType node) {
		super(node);
	}

	public helix_idType(org.w3c.dom.Node node) {
		super(node);
	}

	public helix_idType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public helix_idType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public SchemaIDRef getrefAt(int index) throws Exception {
		return new SchemaIDRef(getDomNodeValue(dereference(getDomChildAt(Attribute, null, "ref", index))));
	}
	...
	public SchemaIDRef getref() throws Exception 
 {
	...
	public void addref(SchemaIDRef value) {
