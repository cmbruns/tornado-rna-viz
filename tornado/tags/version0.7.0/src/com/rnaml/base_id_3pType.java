...
public class base_id_3pType extends com.altova.xml.Node {

	public base_id_3pType(base_id_3pType node) {
		super(node);
	}

	public base_id_3pType(org.w3c.dom.Node node) {
		super(node);
	}

	public base_id_3pType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public base_id_3pType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
