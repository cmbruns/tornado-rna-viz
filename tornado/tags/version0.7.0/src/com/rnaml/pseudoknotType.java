...
public class pseudoknotType extends com.altova.xml.Node {

	public pseudoknotType(pseudoknotType node) {
		super(node);
	}

	public pseudoknotType(org.w3c.dom.Node node) {
		super(node);
	}

	public pseudoknotType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public pseudoknotType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "helix-id" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "helix-id", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new helix_idType(tmpNode).adjustPrefix();
		}
	}
	...
	public SchemaIDRef getdatabase_ids() throws Exception 
 {
	...
	public static int gethelix_idMinCount() {
		return 2;
	}

	public static int gethelix_idMaxCount() {
		return 2;
	}

	public int gethelix_idCount() {
		return getDomChildCount(Element, null, "helix-id");
	}

	public boolean hashelix_id() {
		return hasDomChild(Element, null, "helix-id");
	}

	public helix_idType newhelix_id() {
		return new helix_idType(domNode.getOwnerDocument().createElementNS(null, "helix-id"));
	}

	public helix_idType gethelix_idAt(int index) throws Exception {
		return new helix_idType(dereference(getDomChildAt(Element, null, "helix-id", index)));
	}

	public org.w3c.dom.Node getStartinghelix_idCursor() throws Exception {
		return getDomFirstChild(Element, null, "helix-id" );
	}

	public org.w3c.dom.Node getAdvancedhelix_idCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "helix-id", curNode );
	}

	public helix_idType gethelix_idValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new helix_idType( dereference(curNode) );
	}

	public helix_idType gethelix_id() throws Exception 
 {
		return gethelix_idAt(0);
	}

	public void removehelix_idAt(int index) {
		removeDomChildAt(Element, null, "helix-id", index);
	}

	public void removehelix_id() {
		removehelix_idAt(0);
	}

	public void addhelix_id(helix_idType value) {
		appendDomElement(null, "helix-id", value);	
	}

	public void inserthelix_idAt(helix_idType value, int index) {
		insertDomElementAt(null, "helix-id", index, value);
	}

	public void replacehelix_idAt(helix_idType value, int index) {
		replaceDomElementAt(null, "helix-id", index, value);
	}
