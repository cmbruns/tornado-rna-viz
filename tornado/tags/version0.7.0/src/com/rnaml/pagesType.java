...
public class pagesType extends com.altova.xml.Node {

	public pagesType(pagesType node) {
		super(node);
	}

	public pagesType(org.w3c.dom.Node node) {
		super(node);
	}

	public pagesType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public pagesType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
