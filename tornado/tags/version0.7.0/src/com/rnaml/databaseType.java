...
public class databaseType extends com.altova.xml.Node {

	public databaseType(databaseType node) {
		super(node);
	}

	public databaseType(org.w3c.dom.Node node) {
		super(node);
	}

	public databaseType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public databaseType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
