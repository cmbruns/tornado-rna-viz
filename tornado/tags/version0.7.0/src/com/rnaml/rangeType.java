...
public class rangeType extends com.altova.xml.Node {

	public rangeType(rangeType node) {
		super(node);
	}

	public rangeType(org.w3c.dom.Node node) {
		super(node);
	}

	public rangeType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public rangeType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
