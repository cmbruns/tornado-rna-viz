...
public class seq_annotationType extends com.altova.xml.Node {

	public seq_annotationType(seq_annotationType node) {
		super(node);
	}

	public seq_annotationType(org.w3c.dom.Node node) {
		super(node);
	}

	public seq_annotationType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public seq_annotationType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "modification" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "modification", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new modificationType(tmpNode).adjustPrefix();
		}
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "segment" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "segment", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new segmentType(tmpNode).adjustPrefix();
		}
	}
	...
	public SchemaIDRef getdatabase_ids() throws Exception 
 {
	...
	public static int getmodificationMinCount() {
		return 1;
	}

	public static int getmodificationMaxCount() {
		return 1;
	}

	public int getmodificationCount() {
		return getDomChildCount(Element, null, "modification");
	}

	public boolean hasmodification() {
		return hasDomChild(Element, null, "modification");
	}

	public modificationType newmodification() {
		return new modificationType(domNode.getOwnerDocument().createElementNS(null, "modification"));
	}

	public modificationType getmodificationAt(int index) throws Exception {
		return new modificationType(dereference(getDomChildAt(Element, null, "modification", index)));
	}

	public org.w3c.dom.Node getStartingmodificationCursor() throws Exception {
		return getDomFirstChild(Element, null, "modification" );
	}

	public org.w3c.dom.Node getAdvancedmodificationCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "modification", curNode );
	}

	public modificationType getmodificationValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new modificationType( dereference(curNode) );
	}

	public modificationType getmodification() throws Exception 
 {
		return getmodificationAt(0);
	}

	public void removemodificationAt(int index) {
		removeDomChildAt(Element, null, "modification", index);
	}

	public void removemodification() {
		while (hasmodification())
			removemodificationAt(0);
	}

	public void addmodification(modificationType value) {
		appendDomElement(null, "modification", value);	
	}

	public void insertmodificationAt(modificationType value, int index) {
		insertDomElementAt(null, "modification", index, value);
	}

	public void replacemodificationAt(modificationType value, int index) {
		replaceDomElementAt(null, "modification", index, value);
	}

	public static int getsegmentMinCount() {
		return 1;
	}

	public static int getsegmentMaxCount() {
		return 1;
	}

	public int getsegmentCount() {
		return getDomChildCount(Element, null, "segment");
	}

	public boolean hassegment() {
		return hasDomChild(Element, null, "segment");
	}

	public segmentType newsegment() {
		return new segmentType(domNode.getOwnerDocument().createElementNS(null, "segment"));
	}

	public segmentType getsegmentAt(int index) throws Exception {
		return new segmentType(dereference(getDomChildAt(Element, null, "segment", index)));
	}

	public org.w3c.dom.Node getStartingsegmentCursor() throws Exception {
		return getDomFirstChild(Element, null, "segment" );
	}

	public org.w3c.dom.Node getAdvancedsegmentCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "segment", curNode );
	}

	public segmentType getsegmentValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new segmentType( dereference(curNode) );
	}

	public segmentType getsegment() throws Exception 
 {
		return getsegmentAt(0);
	}

	public void removesegmentAt(int index) {
		removeDomChildAt(Element, null, "segment", index);
	}
	...
	public void addsegment(segmentType value) {
		appendDomElement(null, "segment", value);	
	}

	public void insertsegmentAt(segmentType value, int index) {
		insertDomElementAt(null, "segment", index, value);
	}

	public void replacesegmentAt(segmentType value, int index) {
		replaceDomElementAt(null, "segment", index, value);
	}
