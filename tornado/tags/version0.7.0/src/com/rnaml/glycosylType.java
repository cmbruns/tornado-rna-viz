...
public class glycosylType extends com.altova.xml.Node {

	public glycosylType(glycosylType node) {
		super(node);
	}

	public glycosylType(org.w3c.dom.Node node) {
		super(node);
	}

	public glycosylType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public glycosylType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
