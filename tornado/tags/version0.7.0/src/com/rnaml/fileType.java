...
public class fileType extends com.altova.xml.Node {

	public fileType(fileType node) {
		super(node);
	}

	public fileType(org.w3c.dom.Node node) {
		super(node);
	}

	public fileType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public fileType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
