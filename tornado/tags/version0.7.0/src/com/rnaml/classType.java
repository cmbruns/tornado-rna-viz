...
public class classType extends com.altova.xml.Node {

	public classType(classType node) {
		super(node);
	}

	public classType(org.w3c.dom.Node node) {
		super(node);
	}

	public classType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public classType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
