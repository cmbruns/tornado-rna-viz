...
public class affiliationType extends com.altova.xml.Node {

	public affiliationType(affiliationType node) {
		super(node);
	}

	public affiliationType(org.w3c.dom.Node node) {
		super(node);
	}

	public affiliationType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public affiliationType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
