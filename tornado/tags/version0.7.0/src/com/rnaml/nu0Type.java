...
public class nu0Type extends com.altova.xml.Node {

	public nu0Type(nu0Type node) {
		super(node);
	}

	public nu0Type(org.w3c.dom.Node node) {
		super(node);
	}

	public nu0Type(org.w3c.dom.Document doc) {
		super(doc);
	}

	public nu0Type(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
