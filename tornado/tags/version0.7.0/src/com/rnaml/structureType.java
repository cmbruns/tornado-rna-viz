...
public class structureType extends com.altova.xml.Node {

	public structureType(structureType node) {
		super(node);
	}

	public structureType(org.w3c.dom.Node node) {
		super(node);
	}

	public structureType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public structureType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "model" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "model", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new modelType(tmpNode).adjustPrefix();
		}
	}
	...
	public SchemaIDRef getdatabase_ids() throws Exception 
 {
	...
	public static int getmodelMinCount() {
		return 1;
	}

	public static int getmodelMaxCount() {
		return 1;
	}

	public int getmodelCount() {
		return getDomChildCount(Element, null, "model");
	}

	public boolean hasmodel() {
		return hasDomChild(Element, null, "model");
	}

	public modelType newmodel() {
		return new modelType(domNode.getOwnerDocument().createElementNS(null, "model"));
	}

	public modelType getmodelAt(int index) throws Exception {
		return new modelType(dereference(getDomChildAt(Element, null, "model", index)));
	}

	public org.w3c.dom.Node getStartingmodelCursor() throws Exception {
		return getDomFirstChild(Element, null, "model" );
	}

	public org.w3c.dom.Node getAdvancedmodelCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "model", curNode );
	}

	public modelType getmodelValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new modelType( dereference(curNode) );
	}

	public modelType getmodel() throws Exception 
 {
		return getmodelAt(0);
	}

	public void removemodelAt(int index) {
		removeDomChildAt(Element, null, "model", index);
	}
	...
	public void addmodel(modelType value) {
		appendDomElement(null, "model", value);	
	}

	public void insertmodelAt(modelType value, int index) {
		insertDomElementAt(null, "model", index, value);
	}

	public void replacemodelAt(modelType value, int index) {
		replaceDomElementAt(null, "model", index, value);
	}
