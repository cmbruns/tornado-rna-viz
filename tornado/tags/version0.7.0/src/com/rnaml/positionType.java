...
public class positionType extends com.altova.xml.Node {

	public positionType(positionType node) {
		super(node);
	}

	public positionType(org.w3c.dom.Node node) {
		super(node);
	}

	public positionType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public positionType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
