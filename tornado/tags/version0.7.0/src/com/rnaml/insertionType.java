...
public class insertionType extends com.altova.xml.Node {

	public insertionType(insertionType node) {
		super(node);
	}

	public insertionType(org.w3c.dom.Node node) {
		super(node);
	}

	public insertionType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public insertionType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
