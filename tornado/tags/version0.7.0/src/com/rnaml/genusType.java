...
public class genusType extends com.altova.xml.Node {

	public genusType(genusType node) {
		super(node);
	}

	public genusType(org.w3c.dom.Node node) {
		super(node);
	}

	public genusType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public genusType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
