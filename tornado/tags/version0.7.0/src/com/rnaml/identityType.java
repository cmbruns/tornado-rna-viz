...
public class identityType extends com.altova.xml.Node {

	public identityType(identityType node) {
		super(node);
	}

	public identityType(org.w3c.dom.Node node) {
		super(node);
	}

	public identityType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public identityType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
	...
	public void adjustPrefix() {
		...
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "name" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "name", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new nameType(tmpNode).adjustPrefix();
		}
		for (	org.w3c.dom.Node tmpNode = getDomFirstChild( Element, null, "taxonomy" );
				tmpNode != null;
				tmpNode = getDomNextChild( Element, null, "taxonomy", tmpNode )
			) {
			internalAdjustPrefix(tmpNode, false);
			new taxonomyType(tmpNode).adjustPrefix();
		}
	}
	...
	public SchemaIDRef getdatabase_ids() throws Exception 
 {
	...
	public nameType newname() {
		return new nameType(domNode.getOwnerDocument().createElementNS(null, "name"));
	}

	public nameType getnameAt(int index) throws Exception {
		return new nameType(dereference(getDomChildAt(Element, null, "name", index)));
	}

	public org.w3c.dom.Node getStartingnameCursor() throws Exception {
		return getDomFirstChild(Element, null, "name" );
	}

	public org.w3c.dom.Node getAdvancednameCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "name", curNode );
	}
	...
	public nameType getnameValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			...
			return new nameType( dereference(curNode) );
	}
	...
	public nameType getname() throws Exception 
 {
	...
	public void addname(nameType value) {
		appendDomElement(null, "name", value);	
	}

	public void insertnameAt(nameType value, int index) {
		insertDomElementAt(null, "name", index, value);
	}

	public void replacenameAt(nameType value, int index) {
		replaceDomElementAt(null, "name", index, value);
	}

	public static int gettaxonomyMinCount() {
		return 0;
	}

	public static int gettaxonomyMaxCount() {
		return 1;
	}

	public int gettaxonomyCount() {
		return getDomChildCount(Element, null, "taxonomy");
	}

	public boolean hastaxonomy() {
		return hasDomChild(Element, null, "taxonomy");
	}

	public taxonomyType newtaxonomy() {
		return new taxonomyType(domNode.getOwnerDocument().createElementNS(null, "taxonomy"));
	}

	public taxonomyType gettaxonomyAt(int index) throws Exception {
		return new taxonomyType(dereference(getDomChildAt(Element, null, "taxonomy", index)));
	}

	public org.w3c.dom.Node getStartingtaxonomyCursor() throws Exception {
		return getDomFirstChild(Element, null, "taxonomy" );
	}

	public org.w3c.dom.Node getAdvancedtaxonomyCursor( org.w3c.dom.Node curNode ) throws Exception {
		return getDomNextChild( Element, null, "taxonomy", curNode );
	}

	public taxonomyType gettaxonomyValueAtCursor( org.w3c.dom.Node curNode ) throws Exception {
		if( curNode == null )
			throw new com.altova.xml.XmlException("Out of range");
		else
			return new taxonomyType( dereference(curNode) );
	}

	public taxonomyType gettaxonomy() throws Exception 
 {
		return gettaxonomyAt(0);
	}

	public void removetaxonomyAt(int index) {
		removeDomChildAt(Element, null, "taxonomy", index);
	}
	...
	public void addtaxonomy(taxonomyType value) {
		appendDomElement(null, "taxonomy", value);	
	}

	public void inserttaxonomyAt(taxonomyType value, int index) {
		insertDomElementAt(null, "taxonomy", index, value);
	}

	public void replacetaxonomyAt(taxonomyType value, int index) {
		replaceDomElementAt(null, "taxonomy", index, value);
	}
