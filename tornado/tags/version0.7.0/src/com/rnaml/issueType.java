...
public class issueType extends com.altova.xml.Node {

	public issueType(issueType node) {
		super(node);
	}

	public issueType(org.w3c.dom.Node node) {
		super(node);
	}

	public issueType(org.w3c.dom.Document doc) {
		super(doc);
	}

	public issueType(com.altova.xml.Document doc, String namespaceURI, String prefix, String name) {
